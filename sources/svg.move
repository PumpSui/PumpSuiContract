module suifund::svg {
    const SVG_part1: vector<u8> = b"data:image/svg+xml,%3Csvg width='500' height='697' xmlns='http://www.w3.org/2000/svg'%3E%3Cimage href='https://le32kepvpgpbbabb5szphfvbcq3zdp333n32c7jr2zaelmjnhura.arweave.net/WTelEfV5nhCAIeyy85ahFDeRv3vbd6F9MdZARbEtPSI' height='697' width='500'/%3E%3Cimage href='https://d5qfgbh4cbg4nf4eakrchrx5hy4y5rszmjhprzjke4xbz5zecquq.arweave.net/H2BTBPwQTcaXhAKiI8b9PjmOxlliTvjlKicuHPckFCk' x='50' y='40' height='100'/%3E%3Cimage href='";
